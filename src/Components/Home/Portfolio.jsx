  ...
  return (
    <div className="relative">
      ...
      >
          ...
          {slides.map((slide, index) => (
            ...
            >
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(180deg, rgba(26, 26, 46, 0.4), rgba(26, 26, 46, 0.9))",
                }}
              />
        ...
        <button
          onClick={prevSlide}
          className={`absolute left-6 top-[75%] md:top-1/2 transform -translate-y-1/2 z-30 w-14 h-14 rounded-full border-2 border-[#f0f0f0] bg-transparent text-[#f0f0f0] flex items-center justify-center transition-all duration-300 ${
            isHovered
              ? "opacity-100 visible translate-x-0"
              : "opacity-0 invisible translate-x-12"
        ...
        <button
          onClick={nextSlide}
          className={`absolute right-6 top-[75%] md:top-1/2 transform -translate-y-1/2 z-30 w-14 h-14 rounded-full border-2 border-[#f0f0f0] bg-transparent text-[#f0f0f0] flex items-center justify-center transition-all duration-300 ${
            isHovered
              ? "opacity-100 visible translate-x-0"
              : "opacity-0 invisible -translate-x-12"
          } hover:bg-[#f0f0f0] hover:text-[#1a1a2e]`}
