...
export default function OurPresenceZoom () {
  ...
  return (
    <div className=" bg-gray-100 px-4 mt-6 rounded-4xl">
      <div className="marginal mx-auto">
   
         <div className="w-fit mx-auto mb-6 text-center">
                <div className='space-y-2'>
                    {/* Technology Badge */}
                    <Reveal animation="slide-up mx-aut text-center">
                    ...
                    <Reveal animation="slide-up">
                        {/* <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl leading-snug text-yellow-500 md:px-0">
                            Our Presence
                        </h1> */}
                    </Reveal>
                    <AnimatedHeading
                                  level={1}
                                  duration={1}
                                  className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#1c559d] mb-2"
                                  splitBy="chars"
                                >
                                  Our Presence
                                </AnimatedHeading>
